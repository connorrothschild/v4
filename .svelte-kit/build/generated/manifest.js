const c = [
	...
	() => import("../../../src/routes/experience/layout.svelte"),
	...
	() => import("../../../src/routes/project/layout.svelte"),
	...
	() => import("../../../src/routes/award/layout.svelte"),
...
export const routes = [
	...
	// src/routes/experience/layout.svelte
	[/^\/experience\/layout\/?$/, [c[0], c[4]], [c[1]]],

	// src/routes/experience/moksha.md
	[/^\/experience\/moksha\/?$/, [c[0], c[5]], [c[1]]],

	// src/routes/experience/axios.md
	[/^\/experience\/axios\/?$/, [c[0], c[6]], [c[1]]],

	// src/routes/experience/socom.md
	[/^\/experience\/socom\/?$/, [c[0], c[7]], [c[1]]],

	// src/routes/experience/tpl.md
	[/^\/experience\/tpl\/?$/, [c[0], c[8]], [c[1]]],
	...
	[/^\/project\/map-houston-homicides\/?$/, [c[0], c[10]], [c[1]]],

	// src/routes/project/state-police-spending.md
	[/^\/project\/state-police-spending\/?$/, [c[0], c[11]], [c[1]]],

	// src/routes/project/bob-ross-art-gallery.md
	[/^\/project\/bob-ross-art-gallery\/?$/, [c[0], c[12]], [c[1]]],

	// src/routes/project/map-missing-migrants.md
	[/^\/project\/map-missing-migrants\/?$/, [c[0], c[13]], [c[1]]],

	// src/routes/project/how-many-people.md
	[/^\/project\/how-many-people\/?$/, [c[0], c[14]], [c[1]]],

	// src/routes/project/police-killings.md
	[/^\/project\/police-killings\/?$/, [c[0], c[15]], [c[1]]],

	// src/routes/project/media-mentions.md
	[/^\/project\/media-mentions\/?$/, [c[0], c[16]], [c[1]]],

	// src/routes/project/one-line-hacks.md
	[/^\/project\/one-line-hacks\/?$/, [c[0], c[17]], [c[1]]],

	// src/routes/project/tpl-schools-db.md
	[/^\/project\/tpl-schools-db\/?$/, [c[0], c[18]], [c[1]]],

	// src/routes/project/covid-masking.md
	[/^\/project\/covid-masking\/?$/, [c[0], c[19]], [c[1]]],

	// src/routes/project/quarantunes.md
	[/^\/project\/quarantunes\/?$/, [c[0], c[20]], [c[1]]],

	// src/routes/project/cudi-hums.md
	[/^\/project\/cudi-hums\/?$/, [c[0], c[21]], [c[1]]],

	// src/routes/project/compas.md
	[/^\/project\/compas\/?$/, [c[0], c[22]], [c[1]]],

	// src/routes/project/layout.svelte
	[/^\/project\/layout\/?$/, [c[0], c[23]], [c[1]]],

	// src/routes/project/atus.md
	[/^\/project\/atus\/?$/, [c[0], c[24]], [c[1]]],
	...
	[/^\/award\/rstudio-table-contest-2021\/?$/, [c[0], c[27]], [c[1]]],

	// src/routes/award/d2k-showcase-2020.md
	[/^\/award\/d2k-showcase-2020\/?$/, [c[0], c[28]], [c[1]]],

	// src/routes/award/northeastern-2020.md
	[/^\/award\/northeastern-2020\/?$/, [c[0], c[29]], [c[1]]],

	// src/routes/award/pudding-cup-2020.md
	[/^\/award\/pudding-cup-2020\/?$/, [c[0], c[30]], [c[1]]],

	// src/routes/award/nationals-2017.md
	[/^\/award\/nationals-2017\/?$/, [c[0], c[31]], [c[1]]],

	// src/routes/award/datathon-2020.md
	[/^\/award\/datathon-2020\/?$/, [c[0], c[32]], [c[1]]],

	// src/routes/award/hudspeth-2020.md
	[/^\/award\/hudspeth-2020\/?$/, [c[0], c[33]], [c[1]]],

	// src/routes/award/malofiej-2020.md
	[/^\/award\/malofiej-2020\/?$/, [c[0], c[34]], [c[1]]],

	// src/routes/award/malofiej-2021.md
	[/^\/award\/malofiej-2021\/?$/, [c[0], c[35]], [c[1]]],

	// src/routes/award/bipp-2018.md
	[/^\/award\/bipp-2018\/?$/, [c[0], c[36]], [c[1]]],

	// src/routes/award/chrp-2020.md
	[/^\/award\/chrp-2020\/?$/, [c[0], c[37]], [c[1]]],

	// src/routes/award/hpc-2018.md
	[/^\/award\/hpc-2018\/?$/, [c[0], c[38]], [c[1]]],

	// src/routes/award/hpc-2019.md
	[/^\/award\/hpc-2019\/?$/, [c[0], c[39]], [c[1]]],

	// src/routes/award/hpc-2020.md
	[/^\/award\/hpc-2020\/?$/, [c[0], c[40]], [c[1]]],

	// src/routes/award/snd-2021.md
	[/^\/award\/snd-2021\/?$/, [c[0], c[41]], [c[1]]],

	// src/routes/award/layout.svelte
	[/^\/award\/layout\/?$/, [c[0], c[42]], [c[1]]],

	// src/routes/post/index.svelte
	[/^\/post\/?$/, [c[0], c[43]], [c[1]]],

	// src/routes/post/economist-table-replication-using-reactable.md
	[/^\/post\/economist-table-replication-using-reactable\/?$/, [c[0], c[44]], [c[1]]],

	// src/routes/post/adding-a-chart-to-your-d3-tooltip.md
	[/^\/post\/adding-a-chart-to-your-d3-tooltip\/?$/, [c[0], c[45]], [c[1]]],

	// src/routes/post/tidy-tuesday-powerlifting.md
	[/^\/post\/tidy-tuesday-powerlifting\/?$/, [c[0], c[46]], [c[1]]],

	// src/routes/post/tidy-tuesday-replication.md
	[/^\/post\/tidy-tuesday-replication\/?$/, [c[0], c[47]], [c[1]]],

	// src/routes/post/automation-scrollytell.md
	[/^\/post\/automation-scrollytell\/?$/, [c[0], c[48]], [c[1]]],
