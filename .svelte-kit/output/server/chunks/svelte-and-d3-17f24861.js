...
/* empty css                                             */var svelteAndD3_md_svelte_type_style_lang = "";
const css = {
...
const Svelte_and_d3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
...
export { Svelte_and_d3 as default, metadata };
