...
${validate_component(Code, "Code").$$render($$result, { language: "r", showLineNumbers: false }, {}, {
        default: () => {
          return `<pre class="${"language-r"}"><!-- HTML_TAG_START -->${`<code class="language-r">library<span class="token punctuation">(</span>reactable<span class="token punctuation">)</span>
...
${validate_component(Code, "Code").$$render($$result, { language: "r", showLineNumbers: false }, {}, {
        default: () => {
          return `<pre class="${"language-undefined"}"><!-- HTML_TAG_START -->${`<code class="language-undefined">data %&gt;%
  group_by(month) %&gt;%
...
${validate_component(Code, "Code").$$render($$result, { language: "r" }, {}, {
        default: () => {
          return `<pre class="${"language-r"}"><!-- HTML_TAG_START -->${`<code class="language-r">data <span class="token percent-operator operator">%>%</span>
