...
${validate_component(Info, "Info").$$render($$result, {}, {}, {
        default: () => {
          return `<p>We\u2019re using the <code>$</code> notation here because <code>chartWidth</code> is <em>reactive</em>; that is, it updates according to another variable, <code>containerWidth</code>, which updates on resize.</p>`;
        }
      })}
...
<span class="token literal-property property">$</span><span class="token operator">:</span> xScale <span class="token operator">=</span> <span class="token function">scaleLinear</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<span class="token literal-property property">$</span><span class="token operator">:</span> yScale <span class="token operator">=</span> <span class="token function">scaleLinear</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
