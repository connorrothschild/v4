	...
	_: {
		...
		routes: [
				...
				},
			{
					...
					types: [],
					page: null,
					endpoint: () => import('../server/entries/endpoints/awards.json/_server.js')
				},
			{
					id: "experience.json",
					...
					types: [],
					page: null,
					endpoint: () => import('../server/entries/endpoints/experience.json/_server.js')
				},
			{
					id: "posts.json",
					pattern: /^\/posts\.json$/,
					...
					types: [],
					page: null,
					endpoint: () => import('../server/entries/endpoints/posts.json/_server.js')
				},
			{
					id: "projects.json",
					...
					types: [],
					page: null,
					endpoint: () => import('../server/entries/endpoints/projects.json/_server.js')
				},
			{
					id: "about",
					pattern: /^\/about\/?$/,
